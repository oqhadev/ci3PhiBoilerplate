        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <?php echo form_open($this->config->item("dashboardUrl").'menu/simpan_setting')?>
                        <table class="table table-bordered">
                            ...
                            <tr><td></td><td><button type="submit" class="btn btn-primary btn-sm">Simpan Perubahan</button></td></tr>
                        </table>
                    </form>
                    </div>
                </div>
            ...
            columns: [
                {
                    "data": "id_menu",
                    "orderable": false
                },{"data": "title"},{"data": "url"},{"data": "icon"},{"data": "is_main_menu"},{"data": "urutan"},{"data": "is_aktif"},
                {
                    "data" : "action",
                    "orderable": false,
