...
class User extends CI_Controller
{
    ...
    {
        $this->template->load('admin','user/tbl_user_list',"Admin List");
    } 
    ...
    public function create() 
    {
        $data = array(
            'button'        => 'Create',
            'action'        => site_url($this->config->item("dashboardUrl").'user/create_action'),
        ...
        $this->template->load('admin','user/tbl_user_form',"Create Admin", $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url($this->config->item("dashboardUrl").'user'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button'        => 'Update',
                'action'        => site_url($this->config->item("dashboardUrl").'user/update_action'),
            ...
            $this->template->load('admin','user/tbl_user_form','Update Admin' ,$data);
        } else {
